<template>
    <div v-if="messages.length">
        ...
        <div class="events">
            <div v-for="(item, i) in messages" class="event" :key="i">
                ...
                <div class="content">
                    ...
                    <div class="actions">
                        <el-button link type="primary" :disabled="item.isRead" class="action a-read" @click="readMsg(item.id)">
                            <i class="el-icon-edit"></i>
                            {{ t('action.markedRead') }}
                        </el-button>

                        <el-button link type="danger" class="action a-delete" @click="deleteMsg(item.id)">
        ...
        <div class="flex-center">
            <el-pagination v-model:currentPage="pageRequest.pageNum" v-model:page-size="pageRequest.pageSize" :total="totalSize || 0" layout="prev, pager, next" 
